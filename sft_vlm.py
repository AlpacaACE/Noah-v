...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Noah-v-SFT")
    ...
    args.wandb_run_name = f"Noah-v-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"

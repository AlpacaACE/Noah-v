...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Noah-v Pretrain")
    ...
    parser.add_argument("--wandb_project", type=str, default="Noah-v", help="Weights & Biases project name")
    ...
    args.wandb_run_name = f"Noah-v Pretrain-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
